...
class BloomFilter {
    ...
    public boolean contains(String s) {
        ...
        for (int i = 0; i < noHashes; i++) {
            long hash = hashCode(s, i); // Calculate the i-th hash
            int bitIndex = (int) (hash & this.hashMask); // Get the corresponding bit index

            // If any of the required bits is not set, the element is definitely not in the set
